...
Storage.action('get', function() {
  ...
  self._store.get(self._token, self._username, self._path, function(error, item) {
...
Storage.action('put', function() {
  ...
  self._store.put(self._token, self._username, self._path, type, value, function(error, created, modified) {
...
Storage.action('delete', function() {
  ...
  self._store.delete(self._token, self._username, self._path, function(error, deleted) {
