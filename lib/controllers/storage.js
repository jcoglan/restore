...
Storage.action('options', function() {
  this._headers['Access-Control-Allow-Headers'] = 'Authorization, Content-Length, Content-Type, If-None-Match, Origin, X-Requested-With';
...
Storage.prototype.getVersion = function() {
  ...
  if (ifMatch) return parseInt(ifMatch, 10);
  if (ifNone)  return parseInt(ifNone, 10);
