...
RedisStore.prototype.getItem = function(key, callback) {
  this._redis.get(key, callback);
};
RedisStore.prototype.putItem = function(key, value, callback) {
  this._redis.set(key, value, callback);
};
RedisStore.prototype.deleteItem = function(key, callback) {
