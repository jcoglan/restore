...
FileTree.prototype.get = function(token, username, path, callback) {
  var self  = this,
      isdir = /\/$/.test(path);
  ...
  this.checkToken(token, username, path, 'r', function(error) {
    ...
    if (isdir) {
      ...
      self.readFile(self.dataPath(username, path + '.f'), function(error, json) {
...
FileTree.prototype.put = function(token, username, path, type, value, callback) {
  var self  = this,
...
FileTree.prototype.delete = function(token, username, path, callback) {
  var self = this;
