...
FileStore.prototype.get = function(token, username, category, key, callback) {
  var self     = this,
      username = username.split('@')[0];
...
FileStore.prototype.put = function(token, username, category, key, type, value, callback) {
  var self     = this,
      username = username.split('@')[0];
...
FileStore.prototype.delete = function(token, username, category, key, callback) {
  var self     = this,
      username = username.split('@')[0];
